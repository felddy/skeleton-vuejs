...
issue](https://github.com/cisagov/skeleton-vuejs/issues) in this
...
request](https://github.com/cisagov/skeleton-vuejs/pulls), you will
...
```console
cd skeleton-vuejs
pyenv virtualenv <python_version_to_use> skeleton-vuejs
pyenv local skeleton-vuejs
